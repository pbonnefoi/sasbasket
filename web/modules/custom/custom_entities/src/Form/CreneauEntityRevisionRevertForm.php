...
/**
 * Provides a form for reverting a Creneau entity revision.
 *
 * @ingroup custom_entities
 */
class CreneauEntityRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'creneau_entity_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Creneau entity: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('Creneau entity %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\custom_entities\Entity\CreneauEntityInterface $revision
   ...
   */
  protected function prepareRevertedRevision(CreneauEntityInterface $revision, FormStateInterface $form_state) {
